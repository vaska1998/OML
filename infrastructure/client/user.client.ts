...
import {UserListResponse} from "../dto/profile/user-list.response";
...
export class UserClient extends _RootClient {
    ...
    getTeachers(): Promise<ClientResponse<UserListResponse[]>> {
    ...
    getUserStudents(): Promise<ClientResponse<UserListResponse[]>> {
        return this.proxy.get(`/user/students`);
    }
